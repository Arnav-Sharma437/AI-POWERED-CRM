          ...
          <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
            ...
            <div>
              <h1 style={{ fontSize: "1.5rem", fontWeight: 800, color: "var(--text-primary)", margin: 0 }}>
                {invoiceType === "GST" ? "Create Official Tax Invoice" : "Create Invoice (Without GST / International)"}
              </h1>
              <span style={{ fontSize: "0.8125rem", color: "var(--text-secondary)" }}>
                {invoiceType === "GST" ? "GST-compliant tax invoice with IGST/CGST breakdown" : "Commercial billing statement / Zero-rated export invoice for international & non-GST clients"}
              </span>
            </div>
          </div>
